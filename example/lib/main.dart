...
class _EditorPageState extends State<EditorPage> {
  ...
  final fancyTheme = ChantTheme(
    ...
    leftRight: TextStyleDefinition(size: FontSize.relative(0.9)),
    annotation: TextStyleDefinition(size: FontSize.relative(2 / 3)),
    dropCap: TextStyleDefinition(
      font: GoogleFonts.uncialAntiqua().fontFamily,
      size: FontSize.relative(4),
      color: Colors.deepOrange,
    ),
    aboveLine: const TextStyleDefinition(),
    choralSign: TextStyleDefinition(size: FontSize.staffInterval(1.5)),
    lyric: TextStyleDefinition(size: FontSize.relative(0.9)),
    translation: TextStyleDefinition(size: FontSize.relative(0.75)),
  );
