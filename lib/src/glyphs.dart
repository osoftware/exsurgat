...
const Map<GlyphCode, Glyph> glyphs = {
  ...
  .acuteAccent: Glyph(
    ...
    bounds: Rect(
      ...
      y: 0,
      width:
          0, // TODO: figure out a better way to align this horizontally.  width should be 110.992,
      height: 125.794,
    ),
    origin: Point(0.803, 125.274),
    align: "left",
  ),
  .graveAccent: Glyph(
    paths: [
    ...
    origin: Point(0, 125.274), //x: -110.992
    align: "left",
  ),
  .circle: Glyph(
    paths: [
  ...
  .semicircle: Glyph(
    ...
    bounds: Rect(x: 0, y: 0, width: 100, height: 55),
    origin: Point(-50, 50),
  ),
  .reversedSemicircle: Glyph(
    paths: [
      GlyphPath(
        type: "positive",
        data:
  ...
  .stropha: Glyph(
    ...
    bounds: Rect(x: 0, y: 0, width: 97.657, height: 151.562),
    origin: Point(48, 73.438),
    align: "left",
  ),
  .beginningAscLiquescent: Glyph(
    paths: [
      GlyphPath(
        type: "positive",
        data:
    ...
    bounds: Rect(x: 0, y: 0, width: 100, height: 152.344),
    origin: Point(50, 88.344),
    align: "left",
  ),
  .beginningDesLiquescent: Glyph(
    paths: [
      GlyphPath(
        type: "positive",
        data:
    ...
    bounds: Rect(x: 0, y: 0, width: 100, height: 151.562),
    origin: Point(50, 75.562),
    align: "left",
  ),
  .custosDescLong: Glyph(
    paths: [
      GlyphPath(
        type: "positive",
        data:
    ...
    bounds: Rect(x: 0, y: 0, width: 46.353, height: 339.582),
    origin: Point(0, 65.59),
    align: "left",
  ),
  .custosDescShort: Glyph(
    paths: [
      GlyphPath(
        type: "positive",
        data:
    ...
    bounds: Rect(x: 0, y: 0, width: 43.75, height: 270.053),
    origin: Point(0, 65.89),
    align: "left",
  ),
  .custosLong: Glyph(
    paths: [
  ...
  .custosShort: Glyph(
    ...
    bounds: Rect(x: 0, y: 0, width: 43.75, height: 270.052),
    origin: Point(0, 200.365),
    align: "left",
  ),
  .doClef: Glyph(
    paths: [
    ...
    bounds: Rect(x: 0, y: 0, width: 100, height: 331.251),
    origin: Point(0, 164.876),
    align: "left",
  ),
  .faClef: Glyph(
    paths: [
    ...
    bounds: Rect(x: 0, y: 0, width: 193.752, height: 333.595),
    origin: Point(0.001, 157.001),
    align: "left",
  ),
  .trebleClef: Glyph(
    paths: [
    ...
    bounds: Rect(x: 0, y: 0, width: 671 * 0.8, height: 1756 * 0.8),
    origin: Point(0, 1098 * 0.8),
    align: "left",
  ),
  .trebleClefSmall: Glyph(
    paths: [
      GlyphPath(
        type: "positive",
        data:
    ...
    bounds: Rect(x: 0, y: 0, width: 671 * 0.6, height: 1756 * 0.6),
    origin: Point(0, 1098 * 0.6),
    align: "left",
  ),
  .chiRhoClef: Glyph(
    paths: [
  ...
  .flat: Glyph(
    ...
    bounds: Rect(x: 0, y: 0, width: 97.917, height: 267.969),
    origin: Point(1.042, 204.406),
    align: "left",
  ),
  .mora: Glyph(
    paths: [
    ...
    bounds: Rect(x: 0, y: 0, width: 48, height: 48),
    origin: Point(-24, 24),
    align: "left",
  ),
  .natural: Glyph(
    ...
    bounds: Rect(x: 0, y: 0, width: 70.311, height: 330.469),
    origin: Point(0.312, 166.563),
    align: "left",
  ),
  .sharp: Glyph(
    paths: [
    ...
    bounds: Rect(x: 0, y: 0, width: 154.646, height: 147.987),
    origin: Point(0, 74.098),
    align: "left",
  ),
  .oriscusAsc: Glyph(
    paths: [
    ...
    bounds: Rect(x: 0, y: 0, width: 100, height: 147.656),
    origin: Point(50, 76),
    align: "left",
  ),
  .oriscusDes: Glyph(
    ...
    bounds: Rect(x: 0, y: 0, width: 100, height: 147.656),
    origin: Point(50, 75.406),
    align: "left",
  ),
  .oriscusLiquescent: Glyph(
    paths: [
      GlyphPath(
        type: "positive",
        data:
  ...
  .podatusLower: Glyph(
    ...
    bounds: Rect(x: 0, y: 0, width: 100, height: 103.6),
    origin: Point(50, 51.8),
    align: "left",
  ),
  .podatusLowerShort: Glyph(
    paths: [
      GlyphPath(
        type: "positive",
        data:
    ...
    bounds: Rect(x: 0, y: 0, width: 100, height: 103.124),
    origin: Point(50, 42),
    align: "left",
  ),
  ...
  .podatusUpper: Glyph(
    ...
    bounds: Rect(x: 0, y: 0, width: 91.406, height: 125.781),
    origin: Point(91.406, 63.781),
    align: "right",
  ),
  .podatusUpperShort: Glyph(
    paths: [
      GlyphPath(
        type: "positive",
        data:
  ...
  .porrectus1: Glyph(
    ...
    bounds: Rect(x: 0, y: 0, width: 302.344, height: 215.627),
    origin: Point(50, 52.75),
    align: "left",
  ),
  .porrectus2: Glyph(
    paths: [
    ...
    bounds: Rect(x: 0, y: 0, width: 377.343, height: 328.126),
    origin: Point(50, 68.75),
    align: "left",
  ),
  .porrectus3: Glyph(
    paths: [
    ...
    bounds: Rect(x: 0, y: 0, width: 377.344, height: 427.345),
    origin: Point(50, 70),
    align: "left",
  ),
  .porrectus4: Glyph(
    ...
    bounds: Rect(x: 0, y: 0, width: 420, height: 525.78),
    origin: Point(50, 70),
    align: "left",
  ),
  .punctumCavum: Glyph(
    ...
    bounds: Rect(x: 0, y: 0, width: 100, height: 123.438),
    origin: Point(50, 60.906),
    align: "left",
  ),
  .punctumQuadratum: Glyph(
    paths: [
      GlyphPath(
        type: "positive",
        data:
  ...
  .punctumQuadratumLiquescent: Glyph(
    paths: [
      GlyphPath(
        type: "positive",
        data:
  ...
  .punctumQuadratumAscLiquescent: Glyph(
    paths: [
      GlyphPath(
        type: "positive",
        data:
  ...
  .punctumQuadratumDesLiquescent: Glyph(
    paths: [
      GlyphPath(
        type: "positive",
        data:
  ...
  .punctumInclinatum: Glyph(
    paths: [
      GlyphPath(type: "positive", data: "M0-75.78L50 0 0 75-50 0 0-75.78z"),
    ],
    bounds: Rect(x: 0, y: 0, width: 100, height: 150.78),
    origin: Point(50, 75.78),
    align: "left",
  ),
  .punctumInclinatumLiquescent: Glyph(
    paths: [
      GlyphPath(
        type: "positive",
    ...
    bounds: Rect(x: 0, y: 0, width: 100, height: 105.546),
    origin: Point(50, 53.164),
    align: "left",
  ),
  .quilisma: Glyph(
    paths: [
    ...
    bounds: Rect(x: 0, y: 0, width: 100, height: 150),
    origin: Point(50, 89.282),
    align: "left",
  ),
  .terminatingAscLiquescent: Glyph(
    paths: [
      GlyphPath(
        type: "positive",
        data:
    ...
    bounds: Rect(x: 0, y: 0, width: 49.999, height: 121.873),
    origin: Point(49.999, 48.843),
    align: "right",
  ),
  .terminatingDesLiquescent: Glyph(
    paths: [
      GlyphPath(
        type: "positive",
        data:
    ...
    bounds: Rect(x: 0, y: 0, width: 50, height: 122.658),
    origin: Point(50, 80.97),
    align: "right",
  ),
  .verticalEpisemaAbove: Glyph(
    paths: [
      GlyphPath(
        type: "positive",
    ...
    bounds: Rect(x: 0, y: 0, width: 16, height: 60),
    origin: Point(8, 60),
    align: "left",
  ),
  .verticalEpisemaBelow: Glyph(
    paths: [
      GlyphPath(
        type: "positive",
  ...
  .virgaLong: Glyph(
    ...
    bounds: Rect(x: 0, y: 0, width: 100, height: 326.562),
    origin: Point(50, 66.906),
    align: "left",
  ),
  .virgaShort: Glyph(
    paths: [
    ...
    bounds: Rect(x: 0, y: 0, width: 100, height: 253.126),
    origin: Point(50, 66.906),
    align: "left",
  ),
  .virgula: Glyph(
    ...
    bounds: Rect(x: 0, y: 0, width: 98.014, height: 175.221),
    origin: Point(
      1.074 - 98.014 / 2, // centered
      88.86,
    ),
    align: "left",
  ),
